...
def main():
    # file_loc = "h5_files/output/test_STL/test_STL2.hdf5"
    file_loc = "C:/Users/menth/Documents/Python Scripts/Thesis/h5_files/output/files_test/ply_data_test_205IT_normal_labeled.hdf5"
    args = options()
    
    #Change directory of pretrained
    #args.pretrained = os.path.join(BASE_DIR,'toolboxes/' + args.pretrained)
    args.pretrained = "C:/Users/menth/Documents/Python Scripts/Thesis/toolboxes/learning3d/checkpoints/best_model.t7"
